      ...
      <nav className='nav container'>
        ...
        <div className={Toggle ? "nav__menu show__menu" : "nav__menu"}>
          <ul className='nav__list grid'>
            ...
            <li className='nav__item'>
              <a href='#skills' onClick={() => setActiveNav('#skills')} className={activeNav === '#about' ? 'nav__link active-link' : 'nav__link'}>
                <i className='uil uil-file-alt nav__icon'></i> Skills
              </a>
            </li>
            <li className='nav__item'>
              <a href='#services' onClick={() => setActiveNav('#services')} className={activeNav === '#about' ? 'nav__link active-link' : 'nav__link'}>
            ...
            <li className='nav__item'>
              <a href='#projects' onClick={() => setActiveNav('#projects')} className={activeNav === '#home' ? 'nav__link active-link' : 'nav__link'}>
                <i class="uil uil-desktop nav__icon"></i> Projects
              </a>
            </li>
            <li className='nav__item'>
              <a href='#contact' onClick={() => setActiveNav('#contact')} className={activeNav === '#about' ? 'nav__link active-link' : 'nav__link'}>
